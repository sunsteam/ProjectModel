 ...
 */
public abstract class LoadRecyclerAdapter<T extends Entity, R extends ListRequestBean, Z extends
        ListResponseBean>
    ...
    public LoadRecyclerAdapter(@NonNull R request, @NonNull Loader<R, Z> loaderImp) {
        super();
