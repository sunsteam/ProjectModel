...
public class PagerSlidingTab extends HorizontalScrollView {
    ...
    private int firstTabBackgroundResId;
    private int lastTabBackgroundResId;
        ...
        public void onPageSelected(int position) {
            ...
            for (int i = 0; i < tabCount; i++) {
                ...
                if (v instanceof TextView) {
                    ...
                    textView.setTextColor(i == position ? indicatorColor : tabTextColor);
                }
            }
        }
    }
    ...
    public int getFirstTabBackgroundResId() {
        return firstTabBackgroundResId;
    }

    public void setFirstTabBackgroundResId(int firstTabBackgroundResId) {
        this.firstTabBackgroundResId = firstTabBackgroundResId;
    }

    public int getLastTabBackgroundResId() {
        return lastTabBackgroundResId;
    }

    public void setLastTabBackgroundResId(int lastTabBackgroundResId) {
        this.lastTabBackgroundResId = lastTabBackgroundResId;
    }
